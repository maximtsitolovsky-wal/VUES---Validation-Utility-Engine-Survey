-- =============================================================================
-- Migration 05: Harden dbo.usp_GradeSubmission with invariant checks
-- =============================================================================
-- Goals:
--   1. Keep grading scoped to @SubmissionID only.
--   2. Prevent impossible scores (< 0 or > 100).
--   3. Mark invalid grading states as ERROR instead of writing fake FAIL/PASS.
--   4. Preserve the 95% pass threshold.
--
-- Important business rules:
--   - PASS stores NULL Score in SubmissionLog (legacy behavior kept).
--   - FAIL stores numeric Score in 0..100.
--   - ERROR stores NULL Score and a clear ErrorMessage.
-- =============================================================================
...
BEGIN
    ...
    WHERE
        ...
        OR ISNULL(RefAbbrev, '') <> ISNULL(SubAbbrev, '')
        OR ISNULL(RefDesc, '') <> ISNULL(SubDesc, '')
...
PRINT 'Migration 05 applied: usp_GradeSubmission hardened.';
GO
